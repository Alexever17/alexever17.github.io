...
function mobileMenu() {
    ...
    if (w < 500) {
        ...
        navbar[2].innerHTML = '<a href="contact.html"><img src="icons/001-phone.png" alt="Contact"></a>';
        navbar[3].innerHTML = '<a class="githublink" href="https://github.com/Alexever17/" target="_blank"><img src="icons/002-github.png" alt="Github"></a>';
    }
}
